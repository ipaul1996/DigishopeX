...
public class AdminController {
	...
	public ResponseEntity<Category> updateCategoryHandler(@Validated @RequestBody CategoryDTO category) throws CategoryException {
	...
	public ResponseEntity<DaywiseSalesData> getSalesAnalysisOfDateHandler(@Parameter(description = "dt represents the Target Date(YYYY-MM-DD)") @RequestParam("dt") @NotNull LocalDate targetDate) throws SalesAnalysisNotFoundException {
	...
	public ResponseEntity<List<ProductDTOV4>> getBestsellingProductByRatingInDurationHandler(@Parameter(description = "syr represents start date(YYYY-MM-DD)") @RequestParam("syr") @NotNull LocalDate startDate, @Parameter(description = "eyr represents end date(YYYY-MM-DD)") @RequestParam("eyr") @NotNull LocalDate endDate) throws SalesAnalysisNotFoundException {
